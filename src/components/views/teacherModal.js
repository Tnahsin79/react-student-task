...
import { useUpdateTeacherMutation } from '../api/teacherSlice';
...
export default function TeacherModal({ isOpen, onClose, setIsModalOpen, user, setUserData}) {
  const [open, setOpen] = React.useState(false);
  //   const handleOpen = () => setIsModalOpen(true);
  //   const handleClose = () => setIsModalOpen(false);
  const [userDetail, setUserDetail] = React.useState(user)
  const [updateTeacher, { isLoading, isError, error, data }] = useUpdateTeacherMutation();
